...
/* FUNCTION
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |KC_GRV|  F1  |  F2  |  F3  |  F4  |  F5  |                    |  F6  |  F7  |  F8  |  F9  | F10  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |  UP  |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_FUNC] = LAYOUT( \
  ...
  KC_LSFT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                    _______, _______, _______, _______,             MO(_TMUX), KC_RSFT, TD(TD_PUHM), TD(TD_PDED)
),
/* SHIFT
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |   !  |   @  |   #  |   $  |   %  |                    |      |   ^  |   &  |   *  |   (  |   )  |
...
[_SHIFT] = LAYOUT( \
  ...
  KC_LSFT, TMUX_Z,  TMUX_X,  TMUX_C,  TMUX_V,  _______, _______, _______,    TMUX_N, TMUX_M,  TMUX_COMMA, _______, _______, KC_BSLS,
                             _______, _______, _______,MO(_TMUX), _______, KC_RSFT, KC_LEFT, KC_RGHT
),
/* TMUX
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
  ...
  KC_LSFT, TMUX_Z,  TMUX_X,  TMUX_C,  TMUX_V,  _______, _______, _______,  TMUX_N, TMUX_M,     TMUX_COMMA, _______,     _______, _______,
 ...
 * |      |      | MS_U |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | MS_L | MS_D | MS_R |MsRght|      |-------.    ,-------|  P/P | Vol- | Vol+ |      |      |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      | MUTE |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      | MPRV | MNXT |
 ...
 */
  [_SYSTM] = LAYOUT( \
  KC_WAKE, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, KC_BTN5,                       _______, _______, _______, _______, _______, _______,
  _______, KC_SLEP, KC_MS_U, _______, _______, _______,                       _______, _______, _______, _______, _______, _______,
  _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,                       KC_MPLY, KC_VOLD, KC_VOLU, _______, _______, _______,
