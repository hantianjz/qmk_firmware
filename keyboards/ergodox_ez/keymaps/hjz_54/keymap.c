...
enum layers { _QWERTY, _FUNC, _SHIFT, _TMUX, _SYSTM };
...
[_QWERTY] = LAYOUT_ergodox_pretty(
  // left hand
  QK_GESC,         KC_1,        KC_2,    KC_3,           KC_4,    KC_5,    KC_TRNS,              KC_TRNS,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
  KC_TAB,          KC_Q,        KC_W,    KC_E,           KC_R,    KC_T,    KC_TRNS,              KC_TRNS,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,
  ...
  KC_TRNS,         KC_TRNS,     KC_TRNS, LALT_T(KC_INS), KC_LGUI,                                         TD(TD_LD),   TD(TD_RU),KC_TRNS, KC_TRNS, KC_TRNS,
                                                                 KC_TRNS, KC_TRNS,                KC_TRNS, KC_TRNS,
                                                                          KC_TRNS,                KC_TRNS,
                                              LT(_FUNC, KC_SPC), KC_TRNS, KC_TRNS,                KC_TRNS, KC_TRNS, LT(_SHIFT, KC_SPC)
),
/* Keymap 1: Function
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[_FUNC] = LAYOUT_ergodox_pretty(
  // left hand
  KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_TRNS,     KC_TRNS, KC_F6,   KC_F7,   KC_F8,       KC_F9,   KC_F10,  KC_BSPC,
...
[_TMUX] = LAYOUT_ergodox_pretty(
  // left hand
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,
  KC_TRNS, TMUX_Q,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,    TMUX_CTRL_O, TMUX_P, KC_TRNS,
...
[_SYSTM] = LAYOUT_ergodox_pretty(
  // left hand
  KC_TRNS, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, KC_BTN5, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
