...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LD] = ACTION_TAP_DANCE_DOUBLE(KC_LEFT, KC_DOWN),
    [TD_RU] = ACTION_TAP_DANCE_DOUBLE(KC_RGHT, KC_UP),
    [TD_PDHM] = ACTION_TAP_DANCE_DOUBLE(KC_PGDN, KC_HOME),
    [TD_PUED] = ACTION_TAP_DANCE_DOUBLE(KC_PGUP, KC_END),
};
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |  Alt |  INS |  GUI |                                       | Left | Down |  Up  |Right |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        |      |      |       |      |        |
 *                                 ,------|------|------|       |------+--------+------.
...
[_QWERTY] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS,         KC_TRNS,     KC_LALT,       KC_INS,  KC_LGUI,                                         TD(TD_LD),   TD(TD_RU),KC_TRNS, KC_TRNS, KC_TRNS,
